...
public class LoginController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user2 != null) {
            //dang nhap roi thi lay user by email roi luu tren session chuyen huong ve home
            ...
            // neu chua ton tai trong db chuyen sang trang dang ky bang gg => home
