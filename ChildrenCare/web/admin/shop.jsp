                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="search-bar p-0 d-none d-lg-block ms-2">
                                <div id="search" class="menu-search mb-0">
                                    <form role="search" method="get" id="searchform" class="searchform" action="ServiceListServlet">
                                        <div class="input-group">
                                            <input type="text" class="form-control border rounded-pill" name="search" id="search" placeholder="Tìm dịch vụ..." aria-label="Tìm dịch vụ..." aria-describedby="searchsubmit" oninput="this.form.submit()">                                        </div>
                                    </form>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col mt-4 pt-2">
                                    <a href="#" class="card pharpachy-categories border-0 rounded overflow-hidden">
                                        ...
                                        <div class="category-title">
                                            <span class="text-dark title-white"><span class="h5">${cate.categoryname}</span></span>
                                        </div>
                                    </a>
                                </div><!--end col-->
                            </c:forEach>
