                        ...
                        <div class="layout-specing">
                            ...
                            <table border="1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="PostView?id=<%= p.getId() %>" class="btn btn-view">View</a>
                                        <a href="PostEdit?id=<%= p.getId() %>" class="btn btn-edit">Edit</a>

                                        <form method="POST" action="PostList" style="display:inline;">
...
<!-- Nút thêm bài viết -->
                            <a href="PostAdd" class="btn btn-add">Add New Post</a>
                            <!-- Phân trang -->
                            <div class="row">
                                <div class="col-12 mt-4">
                                    <ul class="pagination justify-content-end mb-0 list-unstyled">
                                        <% if (currentPage > 1) { %>
                                        <li class="page-item">
                                            <a class="page-link" href="PostList?page=<%= currentPage - 1 %>" aria-label="Previous">Prev</a>
                                        </li>
                                        <% } %>

                                        <% for (int i = 1; i <= totalPages; i++) { %>
                                        <li class="page-item <%= (i == currentPage) ? "active" : "" %>">
                                            <a class="page-link" href="PostList?page=<%= i %>"><%= i %></a>
                                        </li>
                                        <% } %>

                                        <% if (currentPage < totalPages) { %>
                                        <li class="page-item">
                                            <a class="page-link" href="PostList?page=<%= currentPage + 1 %>" aria-label="Next">Next</a>
                                        </li>
                                        <% } %>
                                    </ul>
                                </div>
