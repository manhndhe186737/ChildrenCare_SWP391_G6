                        ...
                        <div class="row">
                            <div class="col-lg-12 mt-4">
                                <div class="slider-range-four">
                                    <c:choose>
                                        <c:when test="${not empty service1}">
                                            <c:forEach var="service" items="${service1}">
                                                    ...
                                                    <div class="card shop-list border-0 overflow-hidden rounded shadow m-1">
                                                        ...
                                                        <div class="shop-image position-relative overflow-hidden">
                                                            <a href="serviceDetails?id=${service.id}">
                                                                <img src="${not empty service.img ? service.img : '../assets/images/staff/staff03.jpg'}" class="img-fluid" alt="Service Image">
                                                            </a>
                                                        ...
                                                        <div class="card-body content pt-4 border-top">
                                                            <a href="serviceDetails?id=${service.id}" class="text-dark product-name h6">${not empty service.name ? service.name : "Tên dịch vụ"}</a>
