...
<html lang="en">
    ...
    <head>
        ...
        <style>
            ...
            .slider-container {
                max-width: 1200px; /* Giới hạn chiều rộng tối đa, giống Post List */
            ...
            /* Thêm container cho form filter và nút Add New Slider */
            .filter-and-add {
                display: flex;
                justify-content: space-between; /* Đẩy form sang trái, nút Add sang phải */
                align-items: center;
                margin-bottom: 15px;
            }

            /* Đảm bảo form filter không bị ảnh hưởng */
            .slider-filter-form {
                display: flex;
                align-items: center;
                gap: 10px;
                    ...
                    <div class="layout-specing">
                        ...
                        <div class="slider-container">
                            ...
                            <div class="filter-and-add">
                                ...
                                <a href="slider-add" class="add-slider-btn">+ Add New Slider</a>
                            </div>
