...
<head>
    ...
    <style>
        ...
        /* Đảm bảo các nút có kích thước bằng nhau */
        .filter-buttons-container .filter-button {
            flex: 1;
        }

        /* Điều chỉnh khoảng cách và kích thước của các cột chứa nút */
        .filter-buttons-container .col-md-1 {
            flex: 0 0 auto;
            width: 100px; /* Đặt chiều rộng cố định để các nút có kích thước hợp lý */
        }
    </style>
</head>
                            ...
                            <div class="table-responsive bg-white shadow rounded">
                                ...
                                <form method="get" action="${pageContext.request.contextPath}/c/staff-feedback" class="p-3 border-bottom">
                                    <div class="row g-3 align-items-center">
                                        ...
                                        <!-- Container cho các nút Apply và Reset -->
                                        <div class="col-md-2 filter-buttons-container">
                                            <div class="col-md-1">
                                                <button type="submit" class="filter-button apply-button">Apply</button>
                                            </div>
                                            <div class="col-md-1">
                                                <a href="${pageContext.request.contextPath}/c/staff-feedback" class="filter-button reset-button">Reset</a>
                                            </div>
                                        </div>
                                    </div>
