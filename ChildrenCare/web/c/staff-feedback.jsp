...
<head>
    ...
    <style>
        ...
        .table tr { height: 90px; }
        .avatar-md-sm { width: 50px !important; height: 50px !important; }
        .d-flex.align-items-center .ms-2 { margin-left: 15px !important; }
                        ...
                        <ul class="list-unstyled mb-0 d-md-flex justify-content-between mt-4">
                            <li>
                                <ul class="list-unstyled mb-0">
                                    <li class="d-flex"><h6>Service:</h6><p class="text-muted ms-2">${feedback.reservation.service.name}</p></li>
                                    <li class="d-flex"><h6>Rating:</h6><p class="text-muted ms-2"><c:forEach begin="1" end="5" var="i"><i class="fas fa-star${i <= feedback.rating ? '' : '-o'}"></i></c:forEach></p></li>
                                </ul>
                            </li>
                            <li>
                                <ul class="list-unstyled mb-0">
                                    <li class="d-flex"><h6>Date:</h6><p class="text-muted ms-2">${feedback.date}</p></li>
                                    <li class="d-flex"><h6>Comment:</h6><p class="text-muted ms-2">${feedback.comment}</p></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
