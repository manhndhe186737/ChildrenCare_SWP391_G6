                                    ...
                                    <table class="table table-center bg-white mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-bottom p-3">Tu?i</th>
                                                <th class="border-bottom p-3">Gi?i tính</th>
                                                <th class="border-bottom p-3">??a ch?</th>
                                                <th class="border-bottom p-3">S? ?i?n tho?i</th>
                                                <th class="border-bottom p-3">Ngày sinh</th>
                                                <th class="border-bottom p-3" style="min-width: 150px;">Ngày</th>
                                                <th class="border-bottom p-3">Th?i gian</th>
                                                <th class="border-bottom p-3">Tr?ng thái</th>
