<%-- 
    Document   : index
    Created on : Feb 8, 2025, 10:02:29 AM
    Author     : dell
--%>
            ...
            <c:forEach var="blog" items="${latestBlogs}">
                <div class="col-lg-4 col-md-6 col-12 mb-4 pb-2">
                    <div class="card blog blog-primary border-0 shadow rounded overflow-hidden">
                        <img src="${blog.featuredImage}" class="img-fluid" alt="${blog.title}">
                        <div class="card-body p-4">
                            <ul class="list-unstyled mb-2">
                                <li class="list-inline-item text-muted small me-3">
                                    <i class="uil uil-calendar-alt text-dark h6 me-1"></i>${blog.createdAt}
                                </li>
                                <li class="list-inline-item text-muted small">
                                    <i class="uil uil-clock text-dark h6 me-1"></i>5 min read
                                </li>
                            </ul>
                            <a href="blog-detail.jsp?blogId=${blog.blogId}" class="text-dark title h5">${blog.title}</a>
                            <div class="post-meta d-flex justify-content-between mt-3">
                                <ul class="list-unstyled mb-0">
                                    <li class="list-inline-item me-2 mb-0">
                                        <a href="#" class="text-muted like">
                                            <i class="mdi mdi-heart-outline me-1"></i>33
                                        </a>
                                    </li>
                                ...
                                <a href="blog-detail.jsp?blogId=${blog.blogId}" class="link">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                ...
                                <ul class="list-unstyled footer-list mt-4">
                                    ...
                                    <li><a href="/ChildrenCare/blog" class="text-foot"><i class="mdi mdi-chevron-right me-1"></i> Blog</a></li>
